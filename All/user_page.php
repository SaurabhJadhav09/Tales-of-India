...
<!DOCTYPE html>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Tales Of India</title>
        <link rel="icon" href="./img/rickshaw1.png" type="image/jpg">
				...
				<nav class="navbar navbar-expand-lg  navbar-light">
					<div class="container">
						  <a class="navbar-brand" href="user_page.php">
						  	<!-- <img src="logo6." alt=""> -->
							<h0><strong Style = "color:#FFFF; font-size:20px">🛺Tales Of India</strong></h0>
						  </a>
						  ...
						  <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
						    <ul class="navbar-nav">
								...
								<li><a href="https://www.irctc.co.in/nget/train-search">Train Booking</a></li>
					...
					<div class="container">
						<div class="row fullscreen d-flex align-items-center justify-content-center">
							<div class="banner-content col-lg-10">
								...
								<a href="http://localhost:3000/" class="primary-btn text-uppercase">Explore Now</a>
							</div>											
						</div>
					</div>
				</section>
				  ...
				  <div class="container">
				    ...
				    <div class="filters">
				      <ul>
						...
						<li data-filter=".west">Western</li>
				      </ul>
				    </div>
					
				    <div class="filters-content">
				      <div class="row grid">
						<div class="single-portfolio col-sm-4 all west">
							<div class="item">
							  <img src="img/Mahabaleshwar front.jpg" alt="Work 1">
							  <div class="p-inner">
								  <h5><a href="./State-wise-info.html">Maharashtra</a></h5>
								<div class="cat"></div>
							  </div>
							</div>
						  </div>
				        <div class="single-portfolio col-sm-4 all corporate">
				          <div class="item">
				            ...
				            <div class="p-inner">
				              <h5><a href="./Pages-inside/GoldenTemple-Info.html">Punjab</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all personal">
				          <div class="item">
				            ...
				            <div class="p-inner">
				              <h5><a href="./Pages-inside/GwaliorFort-Info.html">Madhya Pradesh</a></h5>
							    <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all agency">
				          <div class="item">
				            ...
				            <div class="p-inner">
				              <h5><a href="./Pages-inside/Twang-info.html">Arunachal Pradesh</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all portal">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Alleppey-Info.html">Kerala</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        ...
				        <div class="single-portfolio col-sm-4 all corporate">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Camel Safari-Info.html"> Rajasthan</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all agency">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/">Mizoram</a></h5>
				              <div class="cat"> </div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all agency">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Umngot River-Info.html">Meghalaya </a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all portal">
				          <div class="item">
				            <img src="img/Tiruchirapalli front.png" alt="Work 1">
				            <div class="p-inner">
								<h5><a href="./Pages-inside/sri-ranganathar-swamy-temple.html">Tamil Nadu</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>		
				        <div class="single-portfolio col-sm-4 all corporate">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Mehrangarh Fort-Info.html">Rajasthan</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all personal">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Hampi-Info.html">Karnataka</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>
				        <div class="single-portfolio col-sm-4 all portal">
				          <div class="item">
				            ...
				            <div class="p-inner">
								<h5><a href="./Pages-inside/Colva Beach-Info.html">Goa</a></h5>
				              <div class="cat"></div>
				            </div>
				          </div>
				        </div>					        		        
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="single-service">
									<img class="img-fluid" src="img/s1.png" alt=""></a>
									<h4>Chat-bot</h4></a>
									<p>
										"Hello, I'm your friendly chatbot here to assist you 24/7!"
									</p>
							...
							<div class="col-lg-4">
								<div class="single-service">
									<a href= "Season-wise-info.html"><img class="img-fluid" src="img/s2.png" alt=""></a>
									<a href="Season-wise-info.html"> <h4>Season-wise recommendation</h4></a>
									<p>"Discover the perfect experiences, season by season, with our expert suggestions."
									</p>
							...
							<div class="col-lg-4">
								<div class="single-service">
									...
									<a href="itinenary.html"><h4>Personalized Travel Plans</h4></a>
									<p>
										"Crafting unforgettable journeys with personalized travel plans."
									</p>
								</div>
							</div>														
						</div>
